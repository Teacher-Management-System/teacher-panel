      ...
      <DialogHeader>
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            ...
            <DialogDescription>
              {isDenied
                ? "Permissions are currently blocked"
        ...
        {isDenied ? (
          <div className="flex items-start gap-3 p-4 bg-destructive/5 border border-destructive/10 rounded-lg">
            ...
            <div className="text-sm space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                You previously blocked notifications. To receive alerts, follow
                these steps:
              </p>
              <ol className="text-muted-foreground space-y-1 list-decimal list-inside text-xs leading-relaxed">
                <li>
                  Click the <strong>lock icon 🔒</strong> in your browser's
                  address bar
                </li>
                <li>
                  Find <strong>Notifications</strong> in the site settings
                </li>
                <li>
          ...
          <>
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <strong>students, batches, and tickets</strong>. Notifications
              help you respond faster and stay organized.
            </p>
            ...
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              ...
              <div className="text-xs space-y-1">
                ...
                <p className="text-muted-foreground">
                  We only send important updates. You can turn this off anytime
                  in Settings.
                </p>
              </div>
            </div>
      ...
      <DialogFooter className="sm:justify-start gap-2 flex-col sm:flex-row">
        {isDenied ? (
          ...
          <Button
            ...
            className="flex-1 sm:flex-none font-semibold px-8"
          >
            {loading ? "Registering..." : "Enable Notifications"}
          </Button>
        )}
      </DialogFooter>
    </div>
